...
public class GraphModificationController {
    ...
    public GraphModificationController(GraphLoader graphLoader, VertexIndices vertexIndices, Inbox inbox) {
    ...
    private void postChangeEvent(
        ...
        if (successive) {
            subjects.addAll(vertexIndices.getIndexOf(graph.getVertex(edgeId.getTo()))
            ...
            subjects.addAll(vertexIndices.getIndexOf(graph.getVertex(edgeId.getFrom()))
