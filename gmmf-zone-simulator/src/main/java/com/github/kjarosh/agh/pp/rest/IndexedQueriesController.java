...
public class IndexedQueriesController {
    ...
    public IndexedQueriesController(GraphLoader graphLoader, VertexIndices vertexIndices) {
    ...
    public MembersResponseDto members(
        ...
        List<String> members = vertexIndices.getIndexOf(ofVertex).getEffectiveChildrenSet()
                .stream()
    ...
    public EffectivePermissionsResponseDto effectivePermissions(
        ...
        String ep = vertexIndices.getIndexOf(toVertex)
